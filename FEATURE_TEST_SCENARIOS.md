...
- **Login / OTP keyboard:** On login OTP step, focus the code field — **Request OTP code** and **Verify OTP** must stay visible above the keyboard (Android + iOS). Same for signup OTP **Verify OTP**.
