...
- **Photo editor (chat photos):** After editing, tap **Done** — the editor closes and the photo appears in a strip above the **regular chat composer**; type an optional caption there and tap **Send** (caption field no longer lives on the editor preview step for photos). With keyboard open, attach buttons hide so the caption field widens like normal typing.
